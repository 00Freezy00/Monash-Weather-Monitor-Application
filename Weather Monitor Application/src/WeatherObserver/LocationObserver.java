...
/**
 * WeatherObserver.LocationObserver.java
...
public class LocationObserver implements Observer {
     ...
     */
    protected void addMonitorAdapter(MonitorAdapter monitorAdapter) {
        this.monitorAdapterArrayList.add(monitorAdapter);
        passToAdapter(monitorAdapter);
    }
    ...
    /**
     * Remove a monitorAdapter from the array, If there is no adapter inside of the array, it will detach itself from the WeatherObserver.LocationSubject's hashmap
     * @param monitorAdapter A monitor adapter that is currently connected to a monitorGUI
     */
