...
import UI.WeatherTimeLapseFrame;
...
/**
 * UIInterpreter.TimeLapseAdapter.java
 * An adapter class which translates data from WeatherObserver.LocationObserver.java and passes it to UI.WeatherTimeLapseFrame
...
public class TimeLapseAdapter implements MonitorAdapter {
    ...
    /**
     * An init function that constructs a UIInterpreter.TimeLapseAdapter
     *
    ...
    /**
     * A method provided to UI.WeatherTimeLapseFrame to close the adapter
     */
    @Override
